...
#                 # llama2
#                 # assistant_ids = self.tokenizer.encode(conv['content']+" </s>", add_special_tokens=False)
#                 assistant_ids = self.tokenizer.encode(conv['content']+self.tokenizer.eos_token, add_special_tokens=False)
